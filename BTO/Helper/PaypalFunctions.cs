...
{   
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "kentitida-facilitator_api1.gmail.com";
        private string APIPassword = "2QHX4SEZD6GRBB9V";
        private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AZ.fi9hD6D3xrrMKS5gxhUPJ4EI9";
        ...
        public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
        {
            ...
            String hostUrl = HttpContext.Current.Request.Url.AbsoluteUri.Replace(strPathAndQuery, "/");
          
            string returnURL = hostUrl + "Home/CheckoutReview";
            string cancelURL = hostUrl+"Home/CheckoutCancel";

            NVPCodec encoder = new NVPCodec();
            encoder["METHOD"] = "SetExpressCheckout";
            encoder["RETURNURL"] = returnURL;
            encoder["CANCELURL"] = cancelURL;
            encoder["BRANDNAME"] = "ZYMI APPLICATION";
