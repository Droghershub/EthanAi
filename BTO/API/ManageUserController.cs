...
namespace BTO.API
{
    ...
    public class ManageUserController : BTOAPIController
    {
        ...
        [HttpPost]
        // GET api/<controller>
        public async Task<object> ChangePassword(BTO.Models.ChangePasswordViewModel model)
        {
        ...
        [HttpPost]
        // GET api/<controller>
        public async Task<object> UpdateAccount(BTO.Models.RegisterViewModel model)
        {
            var obj = new BaseResponse<int>();
            var UserManager = HttpContext.Current.GetOwinContext().GetUserManager<ApplicationUserManager>();
        ...
        [HttpPost]
        // GET api/<controller>
        public async Task<object> CreateAccount(BTO.Models.RegisterViewModel model)
        {
            var obj = new BaseResponse<int>();
            var UserManager = HttpContext.Current.GetOwinContext().GetUserManager<ApplicationUserManager>();
