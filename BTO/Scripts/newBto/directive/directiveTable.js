    ...
    return {
        ...
        template: function (elem, attrs) {
            var template = '<div id="' + attrs.id + '" class="bto-chart">'
                ...
                + '</td>'
                + '</tr>'
                + '<tr><td class="bto-chart_td_y_title"><div class="bto-chart_y_title">{{configData.y_title | translate}}</div></td></tr>'
                + '<tr><td class="bto-chart_td_first">0</td><td> <div class="bto-chart_x_title">{{configData.x_title | translate}}</div></td><td class="bto-chart_td_last">{{configData.max}}</td></tr>'
                + '</table>'
                + '</div>'
            return template;
        },
        ...
        link: function (scope, elem, attr) {
            ...
            scope.$watch('modelDataX', function () {
                //console.log('X: ' + scope.modelDataX);
                try {
            ...
            scope.$watch('modelDataY', function () {
                //console.log('Y: ' + scope.modelDataY);
                try {
