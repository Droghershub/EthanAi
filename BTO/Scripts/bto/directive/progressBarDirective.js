...
btoApp.factory('ProgressBar', ['$document', '$timeout', '$filter', '$rootScope', function ($document, $timeout, $filter, $rootScope) {
    //'use strict';
    ...
    ProgressBar.prototype = {
        ...
        bindingEvent: function () {
            ...
            // Tooltip event
            $(this.topElem).tooltip({ 'animation': true, hide: { effect: "explode", duration: 1000 }, delay: { show: 1000, hide: 500 }, placement: 'top', title: function () { return $(this).attr('data_title') } });
            $(this.bottomElem).tooltip({ 'animation': true, hide: { effect: "explode", duration: 1000 }, delay: { show: 1000, hide: 500 }, placement: 'bottom', title: function () { return $(this).attr('data_title') } });
        ...
        initElemHandles: function () {
            this.id = this.scope.progressData.id;
            // Color
            ...
            if (this.scope.progressData.isOnlyChangeModel) {
                this.isOnlyChangeModel = this.scope.progressData.isOnlyChangeModel;
