btoApp.service('retirementLifeStyleService', function ($rootScope, utilService, $timeout, CONFIG, $filter) {
            ...
            "graphs": [
              {
                  ...
                  "balloonFunction": function (graphDataItem, graph) {
                      ...
                      var str = utilService.translate("Income from Social Annuities") + ": <span style='font-size:11px; color:#000000;'><b> " + $rootScope.PersonaPlan.currency_code + " " + $filter('number')(dataContext.incomefromsocial, 0) + "</b></span>";
                      str += "<br />";
                      str += utilService.translate("Income from Savings") + ": <span style='font-size:11px; color:#000000;'><b> " + $rootScope.PersonaPlan.currency_code + " " + $filter('number')(dataContext.incomefromsaving, 0) + "</b></span>";
                      str += "<br />";
                      str += utilService.translate("Annual Expense") + ": <span style='font-size:11px; color:#000000;'><b> " + $rootScope.PersonaPlan.currency_code + " " + $filter('number')(dataContext.annualexpense, 0) + "</b></span>";
                      return str;
                  }
              }, {
    ...
    this.bindingDataForView = function (index) {
        ...
        if ($rootScope.IncomeData.income_from_social_security != null) {
            ...
            $rootScope.utilService.scopeApply('dev_detaillifeStype');
        }
    ...
    this.openRowData = function (name) {
        ...
        $rootScope.timelineService.SendingScreenSharingDataObject(name, 'retirementLifeStyle', 'clickOnSavingRate', '');
    }
    this.initChartRetirementImage = function () {
        $('#chart-retirement-image').tooltip();
    }
    return this;
});