...
btoApp.service('illiquidAssetService', function ($rootScope, utilService, $timeout, CONFIG, $filter) {
    ...
    this.InitPercentForDreamDisplay = function (dream) {
      ...
      //  itemReturn['down_payment'] = dream['down_payment'] ;
        itemReturn['mortage_interest_rate'] = dream['mortage_interest_rate'] * 100;
    ...
    this.GetSwiperDream = function (dream) {
        var itemReturn = angular.copy(dream);
        itemReturn['mortage_interest_rate'] = dream['mortage_interest_rate'] / 100;
      //  itemReturn['down_payment'] = dream['down_payment'] / 100;
        itemReturn['mortage_interest_rate'] = dream['mortage_interest_rate'] / 100;
        itemReturn['rental_net_income'] = dream['rental_net_income'] / 100;
        itemReturn['yearly_expenses'] = dream['yearly_expenses'] / 100;
        return itemReturn;
        ...
        if (dream.dream_type_id == 1) {
            for (var i = 0; i < $rootScope.SwiperDreams.length; i++) {
                if ($rootScope.SwiperDreams[i].id == dream.id) {
                    $rootScope.SwiperDreams[i] = dream;
    ...
    this.makeChart = function () {
        ...
        chart = AmCharts.makeChart("chartIlliquid", {
            ...
            "graphs": [{
                "balloonText": utilService.translate("Asset Value") + " <span style='font-size:11px; color:#CC0000;'><b>[[value]]</b></span>",
                "fillAlphas": 1,
                "lineAlpha": 0.2,
                ...
                "balloonText": utilService.translate("Net Value") + " <span style='font-size:11px; color:#CC0000;'><b>[[value]]</b></span>",
                "fillAlphas": 1,
                "lineAlpha": 0.2,
                "stackable": false,
        ...
        zoomedEvent = null;
        $rootScope.illiquidAsset.bindingDataForView(0);
    ...
    this.changeLanguageOfChart = function () {
        chart.graphs[0].balloonText = utilService.translate("Asset Value") + " <span style='font-size:11px; color:#CC0000;'><b>[[value]]</b></span>";
        chart.graphs[0].title = utilService.translate("Asset Value");
        chart.graphs[1].balloonText = utilService.translate("Net Value") + " <span style='font-size:11px; color:#CC0000;'><b>[[value]]</b></span>";
