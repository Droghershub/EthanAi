...
namespace BTO
{
    public static class GlobalConfig
    {
        ...
        public static Dictionary<string, object> GetParameterForNotification(int product_version_id, BTO.Service.IParameterService _paraServices)
        {
            List<Parameter> parameters = _paraServices.GetParameterNotFromRuleByProductVersionId(product_version_id);
            Dictionary<string, object> dictionary = new Dictionary<string, object>();
            foreach (Parameter parameter in parameters)
        ...
        public static void UpdateRuleForCPF(BTO.Models.CPF cpf, List<Persona> personas)
        {
