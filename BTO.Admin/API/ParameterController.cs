...
namespace BTO.API
{
    ...
    public class ParameterController : BTOAPIController
    {
        ...
        public static void GetParametterFromCPF(BTO.Admin.Models.CPF cpf, string parent, Dictionary<string, string> name_value_parametterList, Dictionary<string, string> name_parent_parametterList, Dictionary<string, string> name_issum_parametterList, Dictionary<string, string> name_isformular_parametterList)
        {
