...
{
    [TestClass]
    public class ExpenseAfterRetirementTest
    {
        ...
        public void Initialize()
        {
            ...
            personaInfo.ExpenseAfterRetirement = 400000;
        ...
        public void Test()
        {
            ...
            for (int age = personaInfo.StartingAge; age <= personaInfo.EndingAge; ++age)
            {
                ...
                {
                    expense += expenseAfterRetirement.Expense(type, age);
                }
                if (age < personaInfo.RetirementAge)
                    Assert.AreEqual(expense, 0, "Fail at age: " + age);
                else
                    Assert.AreEqual(expense, personaInfo.ExpenseAfterRetirement * Math.Pow(1 + this.personaInfo.Inflation, age - this.personaInfo.StartingAge), "Fail at age: " + age);
            }
        }
    }
}
