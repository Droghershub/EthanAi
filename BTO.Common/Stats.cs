 ...
 *  jacklam@math.uio.no
 * ****************************************** */
        private static readonly double P_LOW = 0.02425D;
        private static readonly double P_HIGH = 1.0D - P_LOW;
  ...
  { 7.784695709041462e-03,  3.224671290700398e-01,
    2.445134137142996e+00,  3.754408661907416e+00 };
        ...
        public static double getInvCDF(double d, bool highPrecision)
        {
            // Define break-points.
            // variable for result
            double z = 0;

            if (d == 0) z = Double.NegativeInfinity;
            else if (d == 1) z = Double.PositiveInfinity;
  ...
  { 3.16112374387056560E00, 1.13864154151050156E02,
    ...
    1.85777706184603153E-1 };
        ...
        private static readonly double[] ERF_B =
  { 2.36012909523441209E01, 2.44024637934444173E02,
    1.28261652607737228E03, 2.84423683343917062E03 };
        ...
        //C------------------------------------------------------------------
        private static readonly double[] ERF_C =
  { 5.64188496988670089E-1, 8.88314979438837594E0,
    ...
    2.15311535474403846E-8 };
        ...
        private static readonly double[] ERF_D =
  { 1.57449261107098347E01,1.17693950891312499E02,
    ...
    3.43936767414372164E03,1.23033935480374942E03 };
        ...
        //C------------------------------------------------------------------
        private static readonly double[] ERF_P =
  { 3.05326634961232344E-1,3.60344899949804439E-1,
    1.25781726111229246E-1,1.60837851487422766E-2,
    6.58749161529837803E-4,1.63153871373020978E-2 };

        private static readonly double[] ERF_Q =
  { 2.56852019228982242E00,1.87295284992346047E00,
    5.27905102951428412E-1,6.05183413124413191E-2,
    2.33520497626869185E-3 };

        private static readonly double PI_SQRT = Math.Sqrt(Math.PI);
        private static readonly double THRESHOLD = 0.46875D;
         ...
         * ************************************* */
        private static readonly double X_MIN = Double.MinValue;
        private static readonly double X_INF = Double.MinValue;
        private static readonly double X_NEG = -9.38241396824444;
        private static readonly double X_SMALL = 1.110223024625156663E-16;
        private static readonly double X_BIG = 9.194E0;
        private static readonly double X_HUGE = 1.0D / (2.0D * Math.Sqrt(X_SMALL));
        private static readonly double X_MAX = Math.Min(X_INF, (1 / (Math.Sqrt(Math.PI) * X_MIN)));
